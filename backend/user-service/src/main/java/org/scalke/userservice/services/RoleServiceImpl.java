...
public class RoleServiceImpl implements RoleService {
    ...
    @Override
    public Role addNewRole(Role appRole) throws RoleServiceLogicException {
      try {
    ...
    @Override
    public Role findAppRoleByName(String name) throws RoleServiceLogicException {
       try {
    ...
    @Override
    public Role findAppRoleById(long id) throws RoleServiceLogicException {
        try {
    ...
    @Override
    public Page<Role> findAllAppRoles(Pageable pageable) throws RoleServiceLogicException {
        try {
    ...
    @Override
    public Role updateAppRole(Role appRole) throws RoleServiceLogicException {
        try {
            Role role = findAppRoleById(appRole.getId());
    ...
    @Override
    public Role updateAppRole(long roleId, String roleName) throws RoleServiceLogicException {
        try {
            Role role = findAppRoleById(roleId);
    ...
    @Override
    public void deleteAppRole(Role appRole) throws RoleServiceLogicException {
        try {
            Role role = findAppRoleById(appRole.getId());
    ...
    public void deleteAppRole(String name) throws RoleServiceLogicException {
        try {
            Role role = findAppRoleByName(name);
