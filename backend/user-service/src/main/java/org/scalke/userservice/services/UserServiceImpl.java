...
//    public UserDTO addNewUser(User appUser) throws UserServiceLogicException {
//       try {
//
//           if(appUser.getUserType() == UserType.REGULAR ){
//               User creator = findUserById(appUser.getCreatedBy());
//           }
//
//           log.info("Creator : {}, userType : {}, username: {}", appUser.getCreatedBy(), appUser.getUserType(), appUser.getUsername());
//           return userMapper.entityToDto(userRepository.save(User.builder()
...
//        try {
//            User creator = findUserById(request.getCreatedBy());
...
//
//    @Override
//    public void deleteUser(User appUser) throws UserServiceLogicException {
//        try {
...
//
//    @Override
//    public User findUserById(Long id) throws UserNotFoundException, UserServiceLogicException {
//        try {
...
//
//    @Override
//    public UserDTO updateUser(User user) throws UserServiceLogicException {
//        try {
